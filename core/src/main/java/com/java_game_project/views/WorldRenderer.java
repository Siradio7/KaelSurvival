...
public class WorldRenderer {
    ...
    public WorldRenderer(GameWorld world) {
        ...
        this.treeTex = AssetLoader.getTexture("maps/TilesTree.png");
        this.caveTex = AssetLoader.getTexture("maps/mystic_cave.png");
        this.exitTex = AssetLoader.getTexture("images/portail.png");
        this.projectileTex = AssetLoader.getTexture("images/arrow.png");
        ...
        this.playerIdle = new TextureRegion(AssetLoader.getTexture("images/player.png"));
        this.orkIdle = new TextureRegion(AssetLoader.getTexture("maps/ork.png"));
    ...
    public void render(SpriteBatch batch, OrthographicCamera camera) {
        ...
        for (Poulet poulet : world.getPoulets()) {
            TextureRegion frame = (poulet.getState() == EntityState.WALKING)
        ...
        for (Mouton mouton : world.getMoutons()) {
            TextureRegion frame = (mouton.getState() == EntityState.WALKING)
